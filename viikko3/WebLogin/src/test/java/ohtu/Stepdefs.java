...
public class Stepdefs {
    ...
    public void invalidUsernameAndPasswordAndMatchingConfirmationAreEntered(String username, String password) {
        createUserWith(username, password, password);
    }

    @When("a valid username {string} and an invalid password {string} and matching password confirmation are entered")
    public void validUsernameAndAnInvalidPasswordAndMatchingConfirmationAreEntered(String username, String password) {
        createUserWith(username, password, password);
    }

    @When("a valid username {string} and password {string} and an invalid password confirmation {string} are entered")
    public void validUsernameAndPasswordAndAnInvalidConfirmationAreEntered(String username, String password, String passwordConfirmation) {
